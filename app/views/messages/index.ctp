<div class="messages index">
	...
	?>
	<tr<?php echo $class;?>>
		<td><?php echo $message['User']['usuario']; ?></td>
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Nuevo Mensaje', true), array('action' => 'add')); ?></li>
		<li><?php echo $this->Html->link(__('Bandeja de Entrada', true), array('action' => 'index')); ?></li>
		<li><?php echo $this->Html->link(__('Bandeja de Salida', true), array('action' => 'index')); ?></li>
